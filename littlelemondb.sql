...
CREATE TABLE `bookings` (
  ...
  CONSTRAINT `order_id_fk` FOREIGN KEY (`BookingID`) REFERENCES `orders` (`OrderID`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `orderdeliverystatus` (
  ...
  PRIMARY KEY (`OrderID`),
  CONSTRAINT `order_delivery_id_fk` FOREIGN KEY (`OrderID`) REFERENCES `orders` (`OrderID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-01-22 14:46:43
